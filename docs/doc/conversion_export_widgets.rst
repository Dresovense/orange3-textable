...
of "conversion". :doc:`Convert <widgets/convert>` takes as input tabular data in Orange Textable
format and converts them to other formats, in particular the *Table* format
appropriate for further processing within Orange Canvas; :doc:`Convert <widgets/convert>` also
